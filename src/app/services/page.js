import servicecss from './servicecss.module.css'
export default function ServicesPage() {


    return (<div className={servicecss.homePage}>
        <div className={servicecss.nav}>

        </div>

        <div className={servicecss.contentPage}>
            <section id="app-dev">
                ...
                <p>Embark on the Future of App Development with Seasoned Developers in Ranchi! 🚀 Are you in pursuit of visionary app designers and developers in Ranchi? Look no further! Our forward-thinking app development solutions are meticulously crafted to breathe life into your concepts within the digital realm. We harness the power of an array of cutting-edge technologies, including React Native and Flutter, to architect visually mesmerizing and functionally adept cross-platform applications that resonate universally on iOS and Android platforms.
                    ...
                    <br />
                    <br />
                    Our comprehensive technology toolkit includes:
                    <br />
                    <br />

                </p>
                <ul>
                    <li>React Native and Flutter for captivating cross-platform interfaces on iOS and Android
                    </li>
                    <li>Back-end languages such as Node.js, Python, and Java for robust operations
                    </li>
                    <li>AI-powered features for personalized user experiences</li>
                    <li>Cloud integration for scalable and flexible app architecture
                    </li>
            ...
            <section id='web-dev'>
                ...
                <p>
                    Unlock the Digital Potential of Your Ideas with Expert Website Developers and Designers in Ranchi!
                    <br />
                    <br />
                    Welcome to Web Accuracy, your premier destination for cutting-edge website development and design services in Ranchi. Our skilled team of developers and designers is dedicated to turning your visions into stunning and functional online experiences.
                    <br />
                    <br />
                    ...
                    <br />
                    <br />
                    🎨 Design Excellence: A visually appealing website is a powerful tool to leave a lasting impression. Our skilled designers not only have an eye for aesthetics but also an understanding of user-centric design principles. The result? Websites that are not only beautiful but also user-friendly.
                    <br />
                    <br />
            ...
            <section id='ui-ux'>
                ...
                <p>
                    ...
                    <br />
                    <br />
                    Are you searching for top-notch UI/UX designers in Ranchi to transform your digital presence? Look no further! At Web Accuracy, we specialize in creating stunning and intuitive user experiences that leave a lasting impression. Our team of skilled professionals is dedicated to crafting visually appealing and user-friendly websites that engage your audience and drive results.
                </p>
                <br />
                <h3>Our Services:</h3>
                <br />
            ...
            <section id='adshooting-photography'>
                <h1>Ad Shooting and Photography</h1>
                ...
                <br />
                <p>
                    <strong>Experienced Team:</strong>Our team consists of experienced photographers and videographers who are well-versed in the art of visual storytelling. With a keen eye for detail, we capture every moment with precision.
                    <br />
                    <strong>Creative Approach</strong>We take a creative approach to every project, ensuring that each ad or photograph is unique and tailored to your specific needs. Our innovative ideas bring out the best in your brand.
                    <br />
